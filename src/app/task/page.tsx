      ...
      <div className="mt-6 sm:mt-8 px-3 sm:px-4 space-y-3 max-w-[380px] sm:max-w-[400px] mx-auto">
        ...
        {tasks.map((task, index) => {
          ...
          return (
            <MotionDiv
              key={task.taskId}
              className="relative w-full h-[80px] backdrop-blur-[8.4px] border  border-transparent"
              style={{
                borderImage:
            ...
            >
              {/* 内容容器 */}
              <div className="relative w-full h-full rounded-[8px] border flex items-center px-3 sm:px-4">
                {/* 左侧图标和文本区域 */}
